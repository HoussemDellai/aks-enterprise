...
resource "azurerm_resource_group" "rg_aks_backups" {
...
resource "azurerm_storage_account" "aks_backups" {
  ...
  resource_group_name      = azurerm_resource_group.rg_aks_backups.name
  location                 = azurerm_resource_group.rg_aks_backups.location
