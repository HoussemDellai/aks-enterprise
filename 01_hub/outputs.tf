...
output "firewall" {
  value = {
    ...
    private_ip = var.enable_firewall ? azurerm_firewall.firewall.ip_configuration.0.private_ip_address : null
    public_ip  = var.enable_firewall ? azurerm_public_ip.public_ip_firewall.ip_address : null
