...
# data "azurerm_network_watcher" "network_watcher_westeurope" {
...
resource "azurerm_network_watcher_flow_log" "network_flow_logs_nsg_subnet_mgt" {
  ...
  network_watcher_name      = azurerm_network_watcher.network_watcher_westeurope.0.name
  resource_group_name       = azurerm_network_watcher.network_watcher_westeurope.0.resource_group_name
